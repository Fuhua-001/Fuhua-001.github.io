document.addEventListener("DOMContentLoaded", () => {
  ...
  const renderItems = () => {
    ...
    items.forEach((item, index) => {
      ...
      tr.innerHTML = `
                <td>
                    <select onchange="window.updateProductSelection(${index}, this.value)" required style="width: 100%; padding: 0.5rem; border: 1px solid #cbd5e1; border-radius: 6px; background-color: #fff; color: #0f172a;">
